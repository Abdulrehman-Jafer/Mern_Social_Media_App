    ...
    return (
        <main>
            <main className='flex gap-7 justify-center items-center p-4 mb-[5rem] mediaFlexCol text-white'>
                <section>
                    <img src={userimage} alt={userimage} className="sm:h-[100px] sm:w-[100px] h-[80px] w-[80px] rounded-full border-4 border-white" />
                </section>
                <section className='flex flex-col gap-5'>
                    <div className='flex gap-4 items-center justify-center'>
                        <span>{username}</span>
                        <div className='flex items-center gap-2 relative'>
                            <button className='bg-slate-200 px-2 flex gap-1 rounded-sm text-black cursor-default'>
                                <span className='mediaHidden text-black'>Edit</span>
                                Profile
                            </button>
                            <span ref={spanRef}>
